    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(blank=True, max_length=200, null=True, upload_to='manufacture/uploads/%Y/%m/%d/')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manufacture', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_of', to='computerapp.Manufacture')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
